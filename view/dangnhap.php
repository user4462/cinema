        ...
        <div class="case py-3">
            <div class="custom-form">
                <form action="index.php?act=login" method="post">
                    <fieldset>
                        <legend class="py-3 d-flex justify-content-center fs-2 fw-bold" style="color:var(--primary);">DANG NHAP</legend>
                        <div class="my-3">
                            <input type="text" id="disabledTextInput" name="user" class="form-control" placeholder="User">
                        </div>
                        <div class="my-3">
